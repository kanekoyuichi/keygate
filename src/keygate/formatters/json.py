...
_RECOMMENDED_ACTION_BY_RULE: dict[str, str] = {
    ...
    "azure-sas-token": "move_to_secret_manager",
    "huggingface-token": "move_to_secret_manager",
    "dockerhub-token": "move_to_secret_manager",
    "vercel-token": "move_to_secret_manager",
    "sentry-dsn": "manual_review",
    "datadog-api-key": "move_to_secret_manager",
    "discord-token": "move_to_secret_manager",
    "discord-webhook-url": "move_to_secret_manager",
    "telegram-bot-token": "move_to_secret_manager",
    "twilio-auth-token": "move_to_secret_manager",
    "authorization-bearer": "move_to_secret_manager",
    "authorization-basic": "move_to_secret_manager",
